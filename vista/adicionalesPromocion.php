<?php
 include ("../conexion/conexion.php");
    ...
    ////////////////////////////////////////////////////////////////////////777
    $listAdicionales = "SELECT btn_adicional_prom_tmp.BOTONID,adicional.NOMBRE,btn_adicional_prom_tmp.PRECIO PRECIOBTN,adicional.PRECIO PRECIOFIJO,btn_adicional_prom_tmp.CANTIDAD FROM btn_adicional_prom_tmp
    ...
    if (isset($_GET["accion"])) {
        if (($_GET["accion"]) == 'guardarAdicional') {
            if (isset($_GET["id"])) {
                $idBoton = $_GET["id"];
                $cantBtnAdicional = "SELECT * FROM btn_adicional_prom_tmp where BOTONID = $idBoton";
                ...
                if ($resultCantBtnAdicional > 0) {
                    $borrarDatosTablaTemporal = "delete from btn_adicional_prom_tmp where BOTONID = $idBoton";
                    ...
                    $guardarDatosTablaTemporal = "insert into btn_adicional_prom_tmp (BOTONID,CANTIDAD,PRECIO) values ($idBoton,$cantidad,$precio)";
            ...
            $actualizarCantidadPrecio = "update btn_adicional_prom_tmp set CANTIDAD=$cantidad, precio=$precio where botonid=$id";
                    ...
                    <table align="center">
                          <?php
                            ...
                            while ($registroAdicional = $resAdicionales->fetch_array(MYSQLI_BOTH)) {
                                ...
                                $btnAdicionales="SELECT * FROM btn_adicional_prom_tmp";
