...
/////////////////////////////////////////////////////////////
$btnVariedadTablas = "select * from BTN_VARIEDAD_PROM_TMP";
...
$botonCantidad = "select * from BTN_CANTIDAD_PIEZAS_PROM_TMP";
...
/////////////////////////////////////////////////////////////////////////////
$variedadesLista = "SELECT BTN_VARIEDAD_PROM_TMP.BOTONID,BTN_VARIEDAD_PROM_TMP.CANTIDAD,VARIEDADTABLA.NOMBRE FROM  BTN_VARIEDAD_PROM_TMP
INNER JOIN VARIEDADTABLA ON BTN_VARIEDAD_PROM_TMP.BOTONID = VARIEDADTABLA.ID";
...
if (isset($_GET["accion"])) {
    if (($_GET["accion"]) == 'guardarCantidadTabla') {
        ...
        if (isset($_GET["id"])) {
            ...
            $cantVariedad = "update BTN_VARIEDAD_PROM_TMP set CANTIDAD = $cantidadVariedad where BOTONID=$idVariedad";
            echo $cantVariedad;
...
<script type="text/javascript">
    ...
    function guardarCantidadTabla(id) {
        window.location.href = "tablasPromocion.php?accion=guardarCantidadTabla&id=" + id;
    }
            ...
            if (arrayBtnVariedad.length > 0) {
                ...
                if (!cantMaxima) {
                    if ((cantBtnVariedad + 1) > maximoCantidad) {
                        ...
                        window.location.href = "tablasPromocion.php?accion=guardarVariedadTabla&id=" + id+"&cantTablas="+cantTablas;
                    }
                } else {
                    window.location.href = "tablasPromocion.php?accion=guardarVariedadTabla&id=" + id+"&cantTablas="+cantTablas;
                }
            ...
            while ($registroGrupoTablas = $resGrupoTablas->fetch_array(MYSQLI_BOTH)) {
                ...
                <td>
                  <input type="button" value="' . $registroVariedadTablas["NOMBRE"] . '" style="width:140px;height:30px';
                    ...
                    $dibujarBtnVariedadTabla = "select * from BTN_VARIEDAD_PROM_TMP";
